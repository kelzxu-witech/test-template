...
pipx ensurepath
# Clone
git clone https://github.com/witech-io/witech-addons-template
cd witech-addons-template
...
## General witech guidelines

Please follow the official guide from the
[Witech Guidelines page](https://odoo-community.org/page/contributing) where applicable
